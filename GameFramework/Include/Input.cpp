...
//bool CInput::SetUpKey(const std::string& Name, bool State)
//{
//	KeyInfo* Info = FindKeyInfo(Name);
//
//	if (!Info)
...
bool CInput::Init(HWND hWnd)
{
	...
	CreateKey("RenderTileMap", 'U');
	CreateKey("RenderCollider", 'I');
	CreateKey("RenderText", 'T');
