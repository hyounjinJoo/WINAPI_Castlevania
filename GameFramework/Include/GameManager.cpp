...
bool CGameManager::Init(HINSTANCE hInst)
{
	...
	m_hVioletPen = CreatePen(PS_SOLID, 2, RGB(161, 42, 212));
...
ATOM CGameManager::Register()
{
	...
	wcex.lpszClassName = TEXT("Castlevania: Aria of Sorrow");
...
{
	m_hWnd = CreateWindowW(TEXT("Castlevania: Aria of Sorrow"), TEXT("Castlevania: Aria of Sorrow"), WS_OVERLAPPEDWINDOW,
