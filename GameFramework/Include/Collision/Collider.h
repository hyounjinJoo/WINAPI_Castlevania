...
protected:
	...
	std::function<void(CCollider*, CCollider*, float)>	m_WhileFunction;
...
public:
	...
	void CallCollisionWhile(CCollider* Dest, float DeltaTime);
...
public:
	...
	template <typename T>
	void SetCollisionWhileFunction(T* Obj, void(T::* Func)(CCollider*, CCollider*, float))
	{
		m_WhileFunction = std::bind(Func, Obj, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3);
	}
